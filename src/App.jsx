function App() {
  // DOMAIN DETECTION — ADD THIS FIRST
  const [isMainDomain, setIsMainDomain] = useState(false);
  
  useEffect(() => {
    const hostname = window.location.hostname;
    // If this is the main domain (pamojapay.co), show coming soon
    if (hostname === 'pamojapay.co' || hostname === 'www.pamojapay.co') {
      setIsMainDomain(true);
    }
  }, []);
  
  // If main domain, show simple coming soon page
  if (isMainDomain) {
    return (
      <div style={{
        minHeight: '100vh',
        background: 'linear-gradient(135deg, #0a1f3d 0%, #0d3461 100%)',
        display: 'flex',
        alignItems: 'center',
        ...
        <div style={{ textAlign: 'center', color: '#fff' }}>
          ...
          <h1 style={{ fontSize: 32, marginBottom: 8 }}>Coming Soon</h1>
          <p style={{ fontSize: 16, opacity: 0.8 }}>BIDA Cooperative Platform</p>
          <p style={{ fontSize: 14, opacity: 0.6, marginTop: 24 }}>
            Visit <a href="https://bida.pamojapay.co" style={{ color: '#90caf9' }}>bida.pamojapay.co</a>
          </p>
        </div>
      </div>
    );
  ...
  // Otherwise, show your normal BIDA app
